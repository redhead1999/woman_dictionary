    ...
    private void setupAnimators() {
        ...
        C02071 r1 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (f > 0.5f) {
                    ring.setEndTrim(startingEndTrim + ((MaterialProgressDrawable.MAX_PROGRESS_ARC - access$100) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - 0.5f) / 0.5f)));
                }
