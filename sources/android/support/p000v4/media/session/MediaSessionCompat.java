    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(access$400, access$500, i3, i2, i);
        ...
        private MediaMetadataCompat cloneMetadataIfNeeded(MediaMetadataCompat mediaMetadataCompat) {
            ...
            boolean containsKey = mediaMetadataCompat.containsKey(str);
            String str2 = MediaMetadataCompat.METADATA_KEY_ALBUM_ART;
            if (!containsKey && !mediaMetadataCompat.containsKey(str2)) {
                return mediaMetadataCompat;
            }
            Builder builder = new Builder(mediaMetadataCompat);
            Bitmap bitmap = mediaMetadataCompat.getBitmap(str);
            if (bitmap != null) {
                builder.putBitmap(str, bitmap.copy(bitmap.getConfig(), false));
            }
            Bitmap bitmap2 = mediaMetadataCompat.getBitmap(str2);
            if (bitmap2 != null) {
                builder.putBitmap(str2, bitmap2.copy(bitmap2.getConfig(), false));
            }
