...
public class ViewPager extends ViewGroup {
        ...
        if (VERSION.SDK_INT >= 7) {
            ...
            if (method == null) {
                try {
                    ...
                    Log.e(str, "Can't find setChildrenDrawingOrderEnabled", e);
                }
            }
            try {
                this.mSetChildrenDrawingOrderEnabled.invoke(this, new Object[]{Boolean.valueOf(z)});
            } catch (Exception e2) {
                Log.e(str, "Error changing children drawing order", e2);
            }
        }
    }
    ...
    public void draw(android.graphics.Canvas r8) {
        /*
            r7 = this;
            super.draw(r8)
            int r0 = android.support.p000v4.view.ViewCompat.getOverScrollMode(r7)
            r1 = 0
            ...
            goto L_0x0024
        L_0x0018:
            android.support.v4.widget.EdgeEffectCompat r8 = r7.mLeftEdge
            r8.finish()
            android.support.v4.widget.EdgeEffectCompat r8 = r7.mRightEdge
            r8.finish()
            goto L_0x00a9
        L_0x0024:
            ...
            float r5 = r5 * r6
            r8.translate(r4, r5)
            android.support.v4.widget.EdgeEffectCompat r4 = r7.mLeftEdge
            r4.setSize(r2, r3)
            android.support.v4.widget.EdgeEffectCompat r2 = r7.mLeftEdge
            boolean r2 = r2.draw(r8)
            r1 = r1 | r2
            r8.restoreToCount(r0)
        L_0x0065:
            android.support.v4.widget.EdgeEffectCompat r0 = r7.mRightEdge
            boolean r0 = r0.isFinished()
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 61 && VERSION.SDK_INT >= 11) {
