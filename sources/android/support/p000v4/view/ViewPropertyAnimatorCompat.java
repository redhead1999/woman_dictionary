...
public final class ViewPropertyAnimatorCompat {
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: z */
        public void mo3809z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
        }
        ...
        /* renamed from: x */
        public void mo3805x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            postStartMessage(viewPropertyAnimatorCompat, view);
        }
        ...
        /* renamed from: y */
        public void mo3807y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f) {
            postStartMessage(viewPropertyAnimatorCompat, view);
        }
        ...
        private void removeStartMessage(View view) {
            WeakHashMap<View, Runnable> weakHashMap = this.mStarterMap;
            if (weakHashMap != null) {
                Runnable runnable = (Runnable) weakHashMap.get(view);
                if (runnable != null) {
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo3805x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo3807y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo3809z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo3768x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo3805x(this, view, f);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo3770y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo3807y(this, view, f);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo3772z(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo3809z(this, view, f);
        }
        return this;
    }
