...
public class NotificationCompat {
    ...
    public static class Action extends android.support.p000v4.app.NotificationCompatBase.Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, arrayList != null ? (RemoteInput[]) arrayList.toArray(new RemoteInput[arrayList.size()]) : null);
                return action;
            }
        }
    ...
    static class NotificationCompatImplApi20 extends NotificationCompatImplKitKat {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.p000v4.app.NotificationCompatApi20.Builder builder4 = new android.support.p000v4.app.NotificationCompatApi20.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
    ...
    static class NotificationCompatImplJellybean extends NotificationCompatImplBase {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.p000v4.app.NotificationCompatJellybean.Builder builder4 = new android.support.p000v4.app.NotificationCompatJellybean.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
    ...
    static class NotificationCompatImplKitKat extends NotificationCompatImplJellybean {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.p000v4.app.NotificationCompatKitKat.Builder builder4 = new android.support.p000v4.app.NotificationCompatKitKat.Builder(builder2.mContext, builder2.mNotification, builder2.mContentTitle, builder2.mContentText, builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey);
