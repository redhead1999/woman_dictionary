...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (access$600 != null) {
                        ItemTouchHelper.this.mInitialTouchX -= access$600.f31mX;
                        ItemTouchHelper.this.mInitialTouchY -= access$600.f32mY;
    ...
    public static abstract class Callback {
        ...
        public android.support.p003v7.widget.RecyclerView.ViewHolder chooseDropTarget(android.support.p003v7.widget.RecyclerView.ViewHolder r15, java.util.List<android.support.p003v7.widget.RecyclerView.ViewHolder> r16, int r17, int r18) {
            /*
                r14 = this;
                r0 = r15
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0258R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        public void update() {
            ...
            if (f == f2) {
                this.f31mX = ViewCompat.getTranslationX(this.mViewHolder.itemView);
            } else {
            ...
            if (f3 == f4) {
                this.f32mY = ViewCompat.getTranslationY(this.mViewHolder.itemView);
            } else {
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0258R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0258R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    public void startDrag(ViewHolder viewHolder) {
        boolean access$2100 = this.mCallback.hasDragFlag(this.mRecyclerView, viewHolder);
        String str = TAG;
        if (!access$2100) {
            Log.e(str, "Start drag has been called but swiping is not enabled");
    ...
    public void startSwipe(ViewHolder viewHolder) {
        boolean access$2200 = this.mCallback.hasSwipeFlag(this.mRecyclerView, viewHolder);
        String str = TAG;
        if (!access$2200) {
            Log.e(str, "Start swipe has been called but dragging is not enabled");
        } else if (viewHolder.itemView.getParent() != this.mRecyclerView) {
