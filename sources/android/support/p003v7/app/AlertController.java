...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0254R.styleable.AlertDialog, C0254R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0254R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0254R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0254R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0254R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0254R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0254R.styleable.AlertDialog_listItemLayout, 0);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0254R.C0256id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0254R.C0256id.topPanel);
        View findViewById3 = findViewById.findViewById(C0254R.C0256id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0254R.C0256id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0254R.C0256id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0254R.C0256id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0254R.C0256id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0254R.C0256id.buttonPanel);
        ...
        if (!z2 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0254R.C0256id.textSpacerNoButtons);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0254R.C0256id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0254R.C0256id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0254R.C0256id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0254R.C0256id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(16908294);
        if (!TextUtils.isEmpty(this.mTitle)) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0254R.C0256id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0254R.C0256id.scrollView);
