...
public class SolverVariable {
    ...
    static /* synthetic */ class C00031 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.constraint.solver.SolverVariable.C00031.<clinit>():void");
        }
    }
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C00031.$SwitchMap$android$support$constraint$solver$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
