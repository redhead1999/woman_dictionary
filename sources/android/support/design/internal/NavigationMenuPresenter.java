...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    private class NavigationMenuAdapter extends Adapter<ViewHolder> {
        ...
        private void prepareMenuItems() {
            if (!this.mUpdateSuspended) {
                ...
                int i3 = 0;
                while (i < size) {
                    MenuItemImpl menuItemImpl = (MenuItemImpl) NavigationMenuPresenter.this.mMenu.getVisibleItems().get(i);
    ...
    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, OnClickListener onClickListener) {
            super(layoutInflater.inflate(C0007R.layout.design_navigation_item, viewGroup, false));
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0007R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0007R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.mMenuView == null) {
            this.mMenuView = (NavigationMenuView) this.mLayoutInflater.inflate(C0007R.layout.design_navigation_menu, viewGroup, false);
